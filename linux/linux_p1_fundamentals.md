# ---
markmap:
  title: "Linux — Basic Commands & File Management"
  collapse: false
# ---
...
## Theory
- Basic shell commands and file operations are essential for day-to-day server management: navigation, viewing, copying/moving files, and using text utilities.

## Practice
- Use `pwd`, `cd`, `ls`, `cat`, `less`, `cp`, `mv`, `rm`, and `find` effectively; prefer `less` for large logs and `rsync` for efficient backups.
